// Estrutura canônica da Bíblia (66 livros, ordem protestante padrão).
// Gerado a partir de https://bible-api.com/data/almeida — usado para saber
// quantos capítulos cada livro tem e navegar sequencialmente entre eles.
export type BibleBook = {
  /** Código de 3 letras usado pela bible-api.com (ex.: "GEN", "PSA"). */
  id: string;
  /** Nome do livro em português (tradução Almeida). */
  name: string;
  /** Quantidade de capítulos do livro. */
  chapters: number;
};
